...
import qualified FormStructure.Usage as Usage
        ...
        usageType = SimpleGroup
          ...
          , sgItems = [ TextFI
                        { tfiDescriptor = defaultFIDescriptor
                          ...
                          , iLongDescription = Just "Separate the items by newlines. The http://edamontology.org operations are offerred in the autocomplete box."
                          , iAutoComplete = Usage.operations
                          }
                        }
                      ]
          }
